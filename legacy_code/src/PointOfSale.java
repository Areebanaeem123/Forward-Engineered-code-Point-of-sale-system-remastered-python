...
abstract class PointOfSale {
  ...
  public double tax = SystemConfig.TAX_RATE;
  
  public boolean returnSale=true;
  
  // File paths from configuration
  public static String couponNumber = SystemConfig.COUPON_DB;
  public static String tempFile = SystemConfig.TEMP_FILE;
  ...
  public boolean coupon(String couponNo)
  {
      ...
      if (valid)
    	  totalPrice *= SystemConfig.COUPON_DISCOUNT_RATE;
  ...
  public boolean creditCard(String card)
  {
	  ...
	  if (length != SystemConfig.CREDIT_CARD_LENGTH)
		  return false;
	  int index = 0;
	  while (index < length)
	  {
